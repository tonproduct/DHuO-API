...
const current: NodeEntry[] = [
  ...
  },
  {
    ...
    hex: "#5f9ea0",
    hsl: "hsl(182, 26%, 50%)",
    hue: 182, saturation: 26,
    token: "--color/trigger/tool (aprox.)",
    icon: <Wrench size={16} />,
    defense: "Cor única no sistema, sem token documentado. Label usa grey sem vínculo.",
    issues: ["Desconectado visualmente do restante dos Triggers"],
  },
  {
    label: "IA",
    hex: "#7c3aed",
...
const optionA: NodeEntry[] = [
  ...
  },
  {
    ...
    token: "--color/trigger/border",
    icon: <Wrench size={16} />,
    defense: "Herda o verde do Trigger. Distinção por badge, não por cor.",
  },
  {
    label: "IA (IsaTool)",
    hex: "#8b5cf6",
...
const optionB: NodeEntry[] = [
  ...
  },
  {
    ...
    token: "--color/trigger/border",
    icon: <Wrench size={16} />,
    defense: "Herda o teal do Trigger. Distinção por badge, não por cor.",
  },
  {
    label: "IA (IsaTool)",
    hex: "#8b5cf6",
