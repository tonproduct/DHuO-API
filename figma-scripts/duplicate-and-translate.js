// Duplica o frame selecionado e traduz todos os textos PT -> EN no duplicado
const translations = {
...
if (missed.length > 0) {
  ...
  figma.notify(`Duplicado! ${count} traduzido(s)${errors ? `, ${errors} erro(s)` : ''}. Nenhum PT restante!`);
}
